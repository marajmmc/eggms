            ...
            <form id="form_get_voucher_add_edit" class="form_valid" method="post" action="<?php echo base_url().$this->uri->segment(1)."/".$this->uri->segment(2)."/index/save"; ?>" role="form">
                ...
                <div class="box-body">
                    <div class="form-group has-error">
                        ...
                        <input type="text" id="account_name" name="account_name"  placeholder="<?php echo $this->lang->line("NAME"); ?>" class="form-control validate[required]" value="<?php echo $row_info['account_name']?>"  />
                    </div>
                    ...
                    <div class="form-group has-error">
                        ...
                        <select name="type" id="type" class="form-control validate[required]">
                            ...
                            <option value="1" <?php if($row_info['type'] == 1){echo "selected='selected'";}?> ><?php echo $this->lang->line("INCOME"); ?></option>
                            <option value="2" <?php if($row_info['type'] == 2){echo "selected='selected'";}?> ><?php echo $this->lang->line("EXPANSE"); ?></option>
