...
class Create_employee extends CI_Controller
{
    ...
    private function record_save()
    {
        ...
        if($id>0)
        {
            ...
            Query_helper::update('product_category',$data,array("id = ".$id));
        ...
        else
        {
            ...
            Query_helper::add('product_category',$data);
...
//    }
    ...
    private function checkValidation()
    {
        ...
        if (!Validation_helper::is_empty($this->input->post('category_name'))) {
            return false;
        }
