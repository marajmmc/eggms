...
class Bank_statement_entry extends CI_Controller
{
    public $permissions;
    ...
    private function record_add_edit($id)
    {
        ...
        $data['banks'] = $this->$model->get_bank();
    ...
    private function record_save()
    {
        ...
        if($id>0)
        {
            ...
            Query_helper::update('bank_statement',$data,array("id = ".$id));
        ...
        else
        {
            ...
            Query_helper::add('bank_statement',$data);
...
//    }
    ...
    private function checkValidation()
    {
        ...
        if (!Validation_helper::is_empty($this->input->post('bank_id'))) {
            return false;
        }
        if (!Validation_helper::is_empty($this->input->post('amount'))) {
            return false;
        }
        if (!Validation_helper::is_empty($this->input->post('payment_type'))) {
            return false;
        }
