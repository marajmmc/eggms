...
class Create_account_head extends CI_Controller
{
    public $permissions;
    ...
    private function record_save()
    {
        ...
        if($id>0)
        {
            ...
            Query_helper::update('setup_account_head',$data,array("id = ".$id));
        ...
        else
        {
            ...
            Query_helper::add('setup_account_head',$data);
...
//    }
    ...
    private function checkValidation()
    {
        ...
        if (!Validation_helper::is_empty($this->input->post('account_name'))) {
            return false;
        }
